...
const ERROR_MESSAGES = {
  ...
  NAME_TAKEN:
    'Ya existe alguien con ese nombre y apellido. Diferenciate agregando una inicial o variando tu nombre (ej: "Juan C").',
};
    ...
    <div className='auth-page'>
      <div className='auth-card'>
        <div className='text-center mb-4'>
          ...
          />
          <h1 className='brand-text mt-3' style={{ fontSize: '2.4rem' }}>
            CREAR CUENTA
          </h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {error && (
            <div
              ...
              style={{ fontSize: '0.85rem', borderRadius: 'var(--radius-sm)' }}
            >
